...
(function() {
    var toggle = $.getSetIniDbBoolean('discordSettings', 'streamtipToggle', false),
        message = $.getSetIniDbString('discordSettings', 'streamtipMessage', 'Спасибо огромное (name) за tip за $(amount) (currency)!'),
    ...
    $.bind('webPanelSocketUpdate', function(event) {
        if (event.getScript().equalsIgnoreCase('./discord/handlers/streamtipHandler.js')) {
            ...
            message = $.getIniDbString('discordSettings', 'streamtipMessage', 'Спасибо огромное (name) за tip за $(amount) (currency)!');
