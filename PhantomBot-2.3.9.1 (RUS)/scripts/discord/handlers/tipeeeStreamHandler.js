...
(function() {
    var toggle = $.getSetIniDbBoolean('discordSettings', 'tipeeestreamToggle', false),
        message = $.getSetIniDbString('discordSettings', 'tipeeestreamMessage', 'Спасибо огромное (name) за tip за (formattedamount) (currency)!'),
    ...
    $.bind('webPanelSocketUpdate', function(event) {
        if (event.getScript().equalsIgnoreCase('./discord/handlers/tipeeeStreamHandler.js')) {
            ...
            message = $.getIniDbString('discordSettings', 'tipeeestreamMessage', 'Спасибо огромное (name) за tip за (formattedamount) (currency)!');
