(function() {
    var permitList = [],
        ...
        linksMessage = $.getSetIniDbString('chatModerator', 'linksMessage', 'Вы получили ТаймАут за Ссылку.'),
        ...
        capsMessage = $.getSetIniDbString('chatModerator', 'capsMessage', 'Вы получили ТаймАут за Излишнее использование Капса.'),
        ...
        spamMessage = $.getSetIniDbString('chatModerator', 'spamMessage', 'Вы получили ТаймАут за Спам (повторки).'),
        spamLimit = $.getSetIniDbNumber('chatModerator', 'spamLimit', 15),

        symbolsToggle = $.getSetIniDbBoolean('chatModerator', 'symbolsToggle', false),
        symbolsMessage = $.getSetIniDbString('chatModerator', 'symbolsMessage', 'Вы получили ТаймАут за Излишнее использование Символов.'),
        ...
        emotesMessage = $.getSetIniDbString('chatModerator', 'emotesMessage', 'Вы получили ТаймАут за Излишнее использование Смайликов.'),
        ...
        longMessageMessage = $.getSetIniDbString('chatModerator', 'longMessageMessage',  'Вы получили ТаймАут за Излишне большой текст.'),
        ...
        colorsMessage = $.getSetIniDbString('chatModerator', 'colorsMessage', 'Вы получили ТаймАут за использование Цветного текста.'),

        spamTrackerToggle = $.getSetIniDbBoolean('chatModerator', 'spamTrackerToggle', false),
        spamTrackerMessage = $.getSetIniDbString('chatModerator', 'spamTrackerMessage',  'Вы получили ТаймАут за Спам (часто).'),
        ...
        blacklistMessage = $.getSetIniDbString('chatModerator', 'blacklistMessage', 'Вы получили ТаймАут за Запрещенное слово или выражение.'),

        fakePurgeToggle = $.getSetIniDbBoolean('chatModerator', 'fakePurgeToggle', false),
        fakePurgeMessage = $.getSetIniDbString('chatModerator', 'fakePurgeMessage',  'Вы получили ТаймАут за попытку Обмануть систему (Fake Purge).'),
        ...
        silentTimeout = {
            ...
            LinkMessage: $.getSetIniDbString('chatModerator', 'silentLinkMessage', 'Отправка ссылки без разрешения. (Автоматически ботом ' + $.botName + ')'),
            SpamMessage: $.getSetIniDbString('chatModerator', 'silentSpamMessage', 'Чрезмерное использование Текста (повтор текста). (Автоматически ботом ' + $.botName + ')'),
            CapMessage: $.getSetIniDbString('chatModerator', 'silentCapMessage', 'Чрезмерное использование Капса. (Автоматически ботом ' + $.botName + ')'),
            SymbolMessage: $.getSetIniDbString('chatModerator', 'silentSymbolsMessage', 'Чрезмерное использование Символов. (Автоматически ботом ' + $.botName + ')'),
            ColorMessage: $.getSetIniDbString('chatModerator', 'silentColorMessage', 'Использование Цветного текста. (Автоматически ботом ' + $.botName + ')'),
            EmoteMessage: $.getSetIniDbString('chatModerator', 'silentEmoteMessage', 'Чрезмерное использование Смайликов. (Автоматически ботом ' + $.botName + ')'),
            LongMessage: $.getSetIniDbString('chatModerator', 'silentLongMessage', 'Превышен лимит сообщения. (Автоматически ботом ' + $.botName + ')'),
            BlacklistMessage: $.getSetIniDbString('chatModerator', 'silentBlacklistMessage', 'Использование Запрещенного слова или выражения. (Автоматически ботом ' + $.botName + ')'),
            SpamTrackerMessage: $.getSetIniDbString('chatModerator', 'silentSpamTrackerMessage', 'Спам. (Автоматически ботом ' + $.botName + ')'),
            FakePurgeMessage: $.getSetIniDbString('chatModerator', 'silentFakePurgeMessage', 'Обман системы (Fake Purge). (Автоматически ботом ' + $.botName + ')'),
        },
    ...
    function extraCommands(event) {
        ...
        if (command.equalsIgnoreCase('moderation') || command.equalsIgnoreCase('mod')) { // js can't handle anymore commands in the default function.
            ...
            if (action.equalsIgnoreCase('spamtracker')) {
                ...
                if (subAction.equalsIgnoreCase('on') || subAction.equalsIgnoreCase('off')) {
                    ...
                    $.log.event('Модуль "Спам-Трекер" изменен на ' + subAction + ' Изменил(а): ' + sender);
                    return;
                }
            }
            ...
            if (action.equalsIgnoreCase('spamtrackerlimit')) {
                ...
                $.log.event(sender + ' изменил(а) лимит на "Спам-Трекер" до ' + spamTrackerLimit);
                return;
            }
            ...
            if (action.equalsIgnoreCase('spamtrackertime')) {
                ...
                $.log.event(sender + ' изменил(а) время на "Спам-Трекер" до ' + spamTrackerTime);
                return;
            }
            ...
            if (action.equalsIgnoreCase('spamtrackermessage')) {
                ...
                $.log.event(sender + ' изменил(а) предупреждающее сообщение для "Спам-Трекер" на "' + spamTrackerMessage + '"');
                return;
            }
            ...
            if (action.equalsIgnoreCase('regulars')) {
                if (subAction && subAction.equalsIgnoreCase('spamtracker')) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации для "regulars" для "Спам-Трекер" на ' + args[2]);
                        return;
                    }
                }
            }
            ...
            if (action.equalsIgnoreCase('subscribers')) {
                if (subAction && subAction.equalsIgnoreCase('spamtracker')) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации для "subscribers" для "Спам-Трекер" на ' + args[2]);
                        return;
                    }
                }
            }
            ...
            if (action.equalsIgnoreCase('silenttimeout')) {
                if (subAction && subAction.equalsIgnoreCase('spamtracker')) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации "Спам-Трекер" для "Тихий режим" на ' + args[2]);
                        return;
                    }
                }
            }
            ...
            if (action.equalsIgnoreCase('warningtime')) {
                if (subAction && subAction.equalsIgnoreCase('spamtracker')) {
                    ...
                    $.log.event(sender + ' изменил(а) время Сообщения для "Спам-Трекер" до: ' + warningTime.SpamTracker);
                }
            }
            ...
            if (action.equalsIgnoreCase('timeouttime')) {
                if (subAction && subAction.equalsIgnoreCase('spamtracker')) {
                    ...
                    $.log.event(sender + ' изменил(а) время ТаймАут для "Спам-Трекер" до: ' + timeoutTime.SpamTracker);
                }
            }
            ...
            if (action.equalsIgnoreCase('fakepurge')) {
                ...
                if (subAction.equalsIgnoreCase('on') || subAction.equalsIgnoreCase('off')) {
                    ...
                    $.log.event('Модуль "Fake-Purge" изменен на ' + subAction + ' Изменил(а): ' + sender);
                    return;
                }
            }
            ...
            if (action.equalsIgnoreCase('fakepurgemessage')) {
                ...
                $.log.event(sender + ' изменил(а) предупреждающее сообщение для "Fake-Purge" на "' + fakePurgeMessage + '"');
                return;
            }
            ...
            if (action.equalsIgnoreCase('regulars')) {
                if (subAction && subAction.equalsIgnoreCase('fakepurge')) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации для "regulars" для "Fake-Purge" на ' + args[2]);
                        return;
                    }
                }
            }
            ...
            if (action.equalsIgnoreCase('subscribers')) {
                if (subAction && subAction.equalsIgnoreCase('fakepurge')) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации для "subscribers" для "Fake-Purge" на ' + args[2]);
                        return;
                    }
                }
            }
            ...
            if (action.equalsIgnoreCase('silenttimeout')) {
                if (subAction && subAction.equalsIgnoreCase('fakepurge')) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации "Fake-Purge" для "Тихий режим" на ' + args[2]);
                        return;
                    }
                }
            }
            ...
            if (action.equalsIgnoreCase('warningtime')) {
                if (subAction && subAction.equalsIgnoreCase('fakepurge')) {
                    ...
                    $.log.event(sender + ' изменил(а) время Сообщения для "Fake-Purge" до: ' + warningTime.FakePurge);
                }
            }
            ...
            if (action.equalsIgnoreCase('timeouttime')) {
                if (subAction && subAction.equalsIgnoreCase('fakepurge')) {
                    ...
                    $.log.event(sender + ' изменил(а) время ТаймАут для "Fake-Purge" до: ' + timeoutTime.FakePurge);
                }
            }
        }
        ...
        if (command.equalsIgnoreCase('blacklist')) {
            ...
            if (action.equalsIgnoreCase('add')) {
                ...
                $.log.event('"' + word + '" было добавлено в Blacklist! Добавил(а): ' + sender);
            }
        ...
        if (command.equalsIgnoreCase('whiteList')) {
            ...
            if (action.equalsIgnoreCase('add')) {
                ...
                $.log.event('"' + link + '" было добавлено в Whitelist! Добавил(а) ' + sender);
            }
        ...
        if (command.equalsIgnoreCase('permit')) {
            ...
            $.log.event(action + ' было выдано Permit (Разрешение)! Выдал(а): ' + sender);
            return;
        }
    }
        ...
        if (command.equalsIgnoreCase('moderation') || command.equalsIgnoreCase('mod')) {
            ...
            if (action.equalsIgnoreCase('links')) {
                ...
                if (subAction.equalsIgnoreCase('on') || subAction.equalsIgnoreCase('off')) {
                    ...
                    $.log.event('Модуль "Фильтрация Ссылок" изменен на ' + subAction + ' Изменил(а): ' + sender);
                    return;
                }
            }
            ...
            if (action.equalsIgnoreCase('caps')) {
                ...
                if (subAction.equalsIgnoreCase('on') || subAction.equalsIgnoreCase('off')) {
                    ...
                    $.log.event('Модуль "Фильтрация Капса" изменен на ' + subAction + ' Изменил(а): ' + sender);
                    return;
                }
            }
            ...
            if (action.equalsIgnoreCase('spam')) {
                ...
                if (subAction.equalsIgnoreCase('on') || subAction.equalsIgnoreCase('off')) {
                    ...
                    $.log.event('Модуль "Фильтрация Спама" изменен на ' + subAction + ' Изменил(а): ' + sender);
                    return;
                }
            }
            ...
            if (action.equalsIgnoreCase('symbols')) {
                ...
                if (subAction.equalsIgnoreCase('on') || subAction.equalsIgnoreCase('off')) {
                    ...
                    $.log.event('Модуль "Фильтрация Символов" изменен на ' + subAction + ' Изменил(а): ' + sender);
                    return;
                }
            }
            ...
            if (action.equalsIgnoreCase('emotes')) {
                ...
                if (subAction.equalsIgnoreCase('on') || subAction.equalsIgnoreCase('off')) {
                    ...
                    $.log.event('Модуль "Фильтрация Смайликов" изменен на ' + subAction + ' Изменил(а): ' + sender);
                    return;
                }
            }
            ...
            if (action.equalsIgnoreCase('colors')) {
                ...
                if (subAction.equalsIgnoreCase('on') || subAction.equalsIgnoreCase('off')) {
                    ...
                    $.log.event('Модуль "Фильтрация Цветного текста" изменен на ' + subAction + ' Изменил(а): ' + sender);
                    return;
                }
            }
            ...
            if (action.equalsIgnoreCase('longmessages')) {
                ...
                if (subAction.equalsIgnoreCase('on') || subAction.equalsIgnoreCase('off')) {
                    ...
                    $.log.event('Модуль "Фильтрация Длинных сообщений" изменен на ' + subAction + ' Изменил(а): ' + sender);
                    return;
                }
            }
            ...
            if (action.equalsIgnoreCase('regulars')) {
                ...
                if (subAction.equalsIgnoreCase('links')) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации для "regulars" для "Фильтрация Ссылок" на ' + args[2]);
                        return;
                    }
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации для "regulars" для "Фильтрация Капса" на ' + args[2]);
                        return;
                    }
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации для "regulars" для "Фильтрация Символов" на ' + args[2]);
                        return;
                    }
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации для "regulars" для "Фильтрация Спама" на ' + args[2]);
                        return;
                    }
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации для "regulars" для "Фильтрация Смайликов" на ' + args[2]);
                        return;
                    }
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации для "regulars" для "Фильтрация Цветного текста" на ' + args[2]);
                        return;
                    }
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации для "regulars" для "Фильтрация Длинных сообщений" на ' + args[2]);
                        return;
                    }
                }
            }
            ...
            if (action.equalsIgnoreCase('subscribers')) {
                ...
                if (subAction.equalsIgnoreCase('links')) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации для "subscribers" для "Фильтрация Ссылок" на ' + args[2]);
                        return;
                    }
                } else if (subAction.equalsIgnoreCase('caps')) {
                    if (!args[2]) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации для "subscribers" для "Фильтрация Капса" на ' + args[2]);
                        return;
                    }
                } else if (subAction.equalsIgnoreCase('symbols')) {
                    if (!args[2]) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации для "subscribers" для "Фильтрация Символов" на ' + args[2]);
                        return;
                    }
                } else if (subAction.equalsIgnoreCase('spam')) {
                    if (!args[2]) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации для "subscribers" для "Фильтрация Спама" на ' + args[2]);
                        return;
                    }
                } else if (subAction.equalsIgnoreCase('emotes')) {
                    if (!args[2]) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации для "subscribers" для "Фильтрация Смайликов" на ' + args[2]);
                        return;
                    }
                } else if (subAction.equalsIgnoreCase('colors')) {
                    if (!args[2]) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации для "subscribers" для "Фильтрация Цветного текста" на ' + args[2]);
                        return;
                    }
                } else if (subAction.equalsIgnoreCase('longmessages')) {
                    if (!args[2]) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации для "subscribers" для "Фильтрация Длинных сообщений" на ' + args[2]);
                        return;
                    }
                }
            }
            ...
            if (action.equalsIgnoreCase('silenttimeout')) {
                ...
                if (subAction.equalsIgnoreCase('links')) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации "Фильтрация Ссылок" для "Тихий режим" на ' + args[2]);
                        return;
                    }
                } else if (subAction.equalsIgnoreCase('caps')) {
                    if (!args[2]) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации "Фильтрация Капса" для "Тихий режим" на ' + args[2]);
                        return;
                    }
                } else if (subAction.equalsIgnoreCase('symbols')) {
                    if (!args[2]) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации "Фильтрация Символов" для "Тихий режим" на ' + args[2]);
                        return;
                    }
                } else if (subAction.equalsIgnoreCase('spam')) {
                    if (!args[2]) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации "Фильтрация Спама" для "Тихий режим" на ' + args[2]);
                        return;
                    }
                } else if (subAction.equalsIgnoreCase('emotes')) {
                    if (!args[2]) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации "Фильтрация Смайликов" для "Тихий режим" на ' + args[2]);
                        return;
                    }
                } else if (subAction.equalsIgnoreCase('colors')) {
                    if (!args[2]) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации "Фильтрация Цветного текста" для "Тихий режим" на ' + args[2]);
                        return;
                    }
                } else if (subAction.equalsIgnoreCase('longmessages')) {
                    if (!args[2]) {
                    ...
                    if (args[2].equalsIgnoreCase('true') || args[2].equalsIgnoreCase('false')) {
                        ...
                        $.log.event(sender + ' изменил(а) условие модерации "Фильтрация Длинных сообщений" для "Тихий режим" на ' + args[2]);
                        return;
                    }
            ...
            if (action.equalsIgnoreCase('warningtime')) {
                ...
                if (subAction.equalsIgnoreCase('links')) {
                    ...
                    $.log.event(sender + ' изменил(а) время Сообщения для "Фильтрация Ссылок" до: ' + warningTime.Links);
                } else if (subAction.equalsIgnoreCase('caps')) {
                    if (!args[2]) {
                    ...
                    $.log.event(sender + ' изменил(а) время Сообщения для "Фильтрация Капса" до: ' + warningTime.Caps);
                } else if (subAction.equalsIgnoreCase('symbols')) {
                    if (!args[2]) {
                    ...
                    $.log.event(sender + ' изменил(а) время Сообщения для "Фильтрация Символов" до: ' + warningTime.Symbols);
                } else if (subAction.equalsIgnoreCase('spam')) {
                    if (!args[2]) {
                    ...
                    $.log.event(sender + ' изменил(а) время Сообщения для "Фильтрация Спама" до: ' + warningTime.Spam);
                } else if (subAction.equalsIgnoreCase('emotes')) {
                    if (!args[2]) {
                    ...
                    $.log.event(sender + ' изменил(а) время Сообщения для "Фильтрация Смайликов" до: ' + warningTime.Emotes);
                } else if (subAction.equalsIgnoreCase('colors')) {
                    if (!args[2]) {
                    ...
                    $.log.event(sender + ' изменил(а) время Сообщения для "Фильтрация Цветного текста" до: ' + warningTime.Colors);
                } else if (subAction.equalsIgnoreCase('longmessages')) {
                    if (!args[2]) {
                    ...
                    $.log.event(sender + ' изменил(а) время Сообщения для "Фильтрация Длинных сообщений" до: ' + warningTime.LongMsg);
                }
            }
            ...
            if (action.equalsIgnoreCase('timeouttime')) {
                ...
                if (subAction.equalsIgnoreCase('links')) {
                    ...
                    $.log.event(sender + ' изменил(а) время ТаймАут для "Фильтрация Ссылок" до: ' + timeoutTime.Links);
                } else if (subAction.equalsIgnoreCase('caps')) {
                    if (!args[2]) {
                    ...
                    $.log.event(sender + ' изменил(а) время ТаймАут для "Фильтрация Капса" до: ' + timeoutTime.Caps);
                } else if (subAction.equalsIgnoreCase('symbols')) {
                    if (!args[2]) {
                    ...
                    $.log.event(sender + ' изменил(а) время ТаймАут для "Фильтрация Символов" до: ' + timeoutTime.Symbols);
                } else if (subAction.equalsIgnoreCase('spam')) {
                    if (!args[2]) {
                    ...
                    $.log.event(sender + ' изменил(а) время ТаймАут для "Фильтрация Спама" до: ' + timeoutTime.Spam);
                } else if (subAction.equalsIgnoreCase('emotes')) {
                    if (!args[2]) {
                    ...
                    $.log.event(sender + ' изменил(а) время ТаймАут для "Фильтрация Смайликов" до: ' + timeoutTime.Emotes);
                } else if (subAction.equalsIgnoreCase('colors')) {
                    if (!args[2]) {
                    ...
                    $.log.event(sender + ' изменил(а) время ТаймАут для "Фильтрация Цветного текста" до: ' + timeoutTime.Colors);
                } else if (subAction.equalsIgnoreCase('longmessages')) {
                    if (!args[2]) {
                    ...
                    $.log.event(sender + ' изменил(а) время ТаймАут для "Фильтрация Длинных сообщений" до: ' + timeoutTime.LongMsg);
                }
            }
            ...
            if (action.equalsIgnoreCase('linksmessage')) {
                ...
                $.log.event(sender + ' изменил(а) предупреждающее сообщение для "Фильтрация Ссылок" на "' + linksMessage + '"');
                return;
            }
            ...
            if (action.equalsIgnoreCase('capsmessage')) {
                ...
                $.log.event(sender + ' изменил(а) предупреждающее сообщение для "Фильтрация Капса" на "' + capsMessage + '"');
                return;
            }
            ...
            if (action.equalsIgnoreCase('symbolsmessage')) {
                ...
                $.log.event(sender + ' изменил(а) предупреждающее сообщение для "Фильтрация Символов" на "' + symbolsMessage + '"');
                return;
            }
            ...
            if (action.equalsIgnoreCase('emotesmessage')) {
                ...
                $.log.event(sender + ' изменил(а) предупреждающее сообщение для "Фильтрация Смайликов" на "' + emotesMessage + '"');
                return;
            }
            ...
            if (action.equalsIgnoreCase('colorsmessage')) {
                ...
                $.log.event(sender + ' изменил(а) предупреждающее сообщение для "Фильтрация Цветного текста" на "' + colorsMessage + '"');
                return;
            }
            ...
            if (action.equalsIgnoreCase('longmsgmessage')) {
                ...
                $.log.event(sender + ' изменил(а) предупреждающее сообщение для "Фильтрация Длинных сообщений" на "' + longMessageMessage + '"');
                return;
            }
            ...
            if (action.equalsIgnoreCase('spammessage')) {
                ...
                $.log.event(sender + ' изменил(а) предупреждающее сообщение для "Фильтрация Спама" на "' + spamMessage + '"');
                return;
            }
            ...
            if (action.equalsIgnoreCase('blacklistmessage')) {
                ...
                $.log.event(sender + ' изменил(а) предупреждающее сообщение для "Черный список" на "' + blacklistMessage + '"');
                return;
            }
            ...
            if (action.equalsIgnoreCase('permittime')) {
                ...
                $.log.event(sender + ' изменил(а) доступное время для "Permit (Разрешение) до: ' + linkPermitTime + ' секунд');
                return;
            }
            ...
            if (action.equalsIgnoreCase('capslimit')) {
                ...
                $.log.event(sender + ' изменил(а) значение максимально доступного процента для "Фильтрация Спама" до: ' + capsLimitPercent);
                return;
            }
            ...
            if (action.equalsIgnoreCase('capstriggerlength')) {
                ...
                $.log.event(sender + ' изменил(а) допустимое количество символов для "Фильтрация Капса" до: ' + capsTriggerLength);
                return;
            }
            ...
            if (action.equalsIgnoreCase('spamlimit')) {
                ...
                $.log.event(sender + ' изменил(а) допустимое количество символов для "Фильтрация Спама" до: ' + spamLimit);
                return;
            }
            ...
            if (action.equalsIgnoreCase('symbolslimit')) {
                ...
                $.log.event(sender + ' изменил(а) значение максимально доступного процента для "Фильтрация Символов" до: ' + symbolsLimitPercent);
                return;
            }
            ...
            if (action.equalsIgnoreCase('symbolsgrouplimit')) {
                ...
                $.log.event(sender + ' изменил(а) допустимое количество Групповых символов для "Фильтрация Символов" до: ' + symbolsGroupLimit);
                return;
            }
            ...
            if (action.equalsIgnoreCase('symbolsTriggerLength')) {
                ...
                $.log.event(sender + ' изменил(а) допустимое количество символов для "Фильтрация Символов" до: ' + symbolsTriggerLength);
                return;
            }
